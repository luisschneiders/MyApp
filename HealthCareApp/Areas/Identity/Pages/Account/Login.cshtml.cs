...
namespace MyApp.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                // This line was add because we are now have the ability to update Model.UserName
                // PasswordSignInAsync uses Model.UserName instead of the Model.Email
                // So validate the email by finding UserName of the email entered
